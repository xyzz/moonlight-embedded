...
static unsigned int settings_special_codes[] = {
  0,
  ...
  ANALOG_LEFT_TRIGGER     | INPUT_TYPE_ANALOG,
  ANALOG_RIGHT_TRIGGER    | INPUT_TYPE_ANALOG,
...
static char *settings_special_names[] = {
  "None",
  "Pause stream",
  "Special (XBox button)",
  "LB",
